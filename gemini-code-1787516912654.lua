-- ============================================
-- SWILL | FULL SCRIPT (DDD + ESP + MISC)
-- ============================================
...
local wallCheckEnabled = true -- Проверка стен для Silent Aim
local aimFOV = 200
local drawFOV = false
local fovCircle = nil
local target = nil
...
-- Функция поиска целей в FOV с учетом выбора части тела (Head/Torso)
...
Rayfield:Notify({
    Title = "Готово",
    Content = "Триггербот удален. Скрипт обновлен!",
    Duration = 3,
    Image = 4483362458,
})