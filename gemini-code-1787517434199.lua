-- ============================================
-- SWILL | NEVERLOSE-BASED SILENT AIM + RAYFIELD UI
-- ============================================
...
local Settings = {
    SilentAim = false,
    HitPart = "Head", -- "Head" или "Torso" (UpperTorso)
    ESP = false,
    ESPBoxes = true,
    ESPNames = true,
    ESPDistance = true,
...
local function isEnemy(player)
    ...
    -- Проверка кастомного статуса команды (если есть в игре)
    ...
    -- Стандартная командная проверка Roblox
...
-- ============================
-- SILENT AIM (С выбором Head / Torso)
-- ============================
...
Rayfield:Notify({
    Title = "Готово",
    Content = "Silent Aim изменен под нужный шаблон с выбором части тела!",
    Duration = 3,
    Image = 4483362458,
})