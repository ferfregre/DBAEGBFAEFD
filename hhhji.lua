...
local function isVisible(targetPart)
    ...
    return not result or result.Instance:FindFirstAncestorOfClass("Model") ~= nil
end
...
makeSwitch(contentFrames["ESP"], "Night", 165, function() return Settings.Night end, function(v) Settings.Night = v end)
